...
pub struct InstantiateMsg {
    ...
    /// The xLOCAL staking contract address
    pub staking_contract: String,
    /// The governance contract address (fee distributor for vxLOCAL)
    ...
    /// The maximum spread used when swapping fee tokens to LOCAL
...
pub enum ExecuteMsg {
    /// Collects and swaps fee tokens to LOCAL
    Collect {
        /// The assets to swap to LOCAL
    ...
    /// Add bridge tokens used to swap specific fee tokens to LOCAL (effectively declaring a swap route)
    UpdateBridges {
    ...
    /// Distribute LOCAL to stakers and to governance
    DistributeAstro {},
...
pub struct ConfigResponse {
    ...
    /// The governance contract address (fee distributor for vxLOCAL stakers)
    pub governance_contract: Option<Addr>,
    /// The percentage of fees that go to governance_contract
    pub governance_percent: Uint64,
    /// The maximum spread used when swapping fee tokens to LOCAL
    pub max_spread: Decimal,
    /// The remainder LOCAL tokens (accrued before the Maker is upgraded) to be distributed to xLOCAL stakers
    pub remainder_reward: Uint128,
    /// The amount of LOCAL tokens accrued before upgrading the Maker implementation and enabling reward distribution
...
/// This struct holds parameters to help with swapping a specific amount of a fee token to LOCAL.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
