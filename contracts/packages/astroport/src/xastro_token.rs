...
/// This structure describes the parameters used for creating a xLOCAL token contract.
...
pub enum QueryMsg {
    ...
    TokenInfo {},
    /// Returns who can mint xLOCAL and the hard cap on maximum tokens after minting.
    Minter {},
    ...
    /// AllAccounts returns all the accounts that have xLOCAL balances. Supports pagination.
    AllAccounts {
        start_after: Option<String>,
        limit: Option<u32>,
    },
